...
const authorsList: Author[] = [
  ...
  },
  {
    ...
    firstName: "Federica",
    lastName: "Martelli",
    bio: "La Prof.ssa Federica Martelli è una stimata esperta in psicologia clinica e meditazione, con una specializzazione nel miglioramento della salute mentale attraverso la meditazione. Dopo aver conseguito il dottorato in Psicologia presso l'Università di Torino, ha dedicato la sua carriera alla ricerca e all'applicazione delle tecniche meditative per potenziare il benessere psicologico. Attualmente, la Prof.ssa Martelli è docente di Psicologia della Salute all'Università di Genova, dove guida studi innovativi sull'efficacia della meditazione nel trattamento dello stress, dell'ansia e della depressione. È autrice di numerosi articoli scientifici e partecipa come relatrice a conferenze internazionali, e il suo lavoro è ampiamente riconosciuto per il contributo alla diffusione delle pratiche meditative come strategie efficaci per la salute mentale.",
  },
  {
    id: 13,
    firstName: "Carla",
